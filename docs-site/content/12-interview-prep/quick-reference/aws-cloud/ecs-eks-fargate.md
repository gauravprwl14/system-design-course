...
- [AWS EC2 Instances, ASG & Placement Groups](/12-interview-prep/quick-reference/aws-cloud/ec2-instances)
- [AWS Lambda for Serverless Architecture](/12-interview-prep/quick-reference/aws-cloud/lambda-serverless)
- [AWS API Gateway](/12-interview-prep/quick-reference/aws-cloud/api-gateway)
