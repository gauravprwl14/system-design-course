...
This guide helps you navigate the System Design Knowledge Base based on your goals and timeline.
...
- Search by topic, concept, or company
- Searches include code examples
...
- Right sidebar shows article sections
- Click to jump to specific section
- Auto-highlights current section

### Difficulty Levels
- 🟢 **Beginner** - Start here if new to topic
...
See [Getting Started](/get-started#study-plans) for detailed study plans:
- 30-Day Comprehensive
- 2-Week Interview Prep
- 1-Week Crash Course
