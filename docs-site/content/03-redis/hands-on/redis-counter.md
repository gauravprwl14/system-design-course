...
- [POC: Rate Limiting with Sliding Window](/06-scalability/hands-on/rate-limiting-algorithms) - Using counters for rate limits
- [POC: HyperLogLog Unique Visitors](/03-redis/hands-on/redis-hyperloglog) - Unique counter estimation
